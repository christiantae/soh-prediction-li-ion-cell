function [rmse,RUL_error,RUL_upper,RUL_lower] = Linear_Sqrt_Bayes(cyc,usedcap,num_cycles,i)
...
title({['Bayesian Sqrt Model'];['Cell ',num2str(i),', Prediction RMSE: ',num2str(rmse),...
