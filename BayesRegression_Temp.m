...
for i = 1:length(model_type)
    ...
    [rmse,RUL_error,upper,lower] = Linear_Sqrt_Bayes_TempFeature(cyc1,usedcap1,num_cycles,1,avg1',model_type(i));
...
for i = 1:length(model_type)
    ...
    xlabel('Cycle')
    ylabel('Used Capacity')
    [rmse,RUL_error,upper,lower] = Linear_Sqrt_Bayes_TempFeature(cyc2,usedcap2,num_cycles,2,avg2',model_type(i));
...
for i = 1:length(model_type)
    ...
    xlabel('Cycle')
    ylabel('Used Capacity')
    [rmse,RUL_error,upper,lower] = Linear_Sqrt_Bayes_TempFeature(cyc3,usedcap3,num_cycles,3,avg3',model_type(i));
...
for i = 1:length(model_type)
    ...
    xlabel('Cycle')
    ylabel('Used Capacity')
    [rmse,RUL_error,upper,lower] = Linear_Sqrt_Bayes_TempFeature(cyc4,usedcap4,num_cycles,4,variance4',model_type(i));
...
for i = 1:length(model_type)
    ...
    xlabel('Cycle')
    ylabel('Used Capacity')
    [rmse,RUL_error,upper,lower] = Linear_Sqrt_Bayes_TempFeature(cyc5,usedcap5,num_cycles,5,avg5',model_type(i));
...
for i = 1:length(model_type)
    ...
    xlabel('Cycle')
    ylabel('Used Capacity')
    [rmse,RUL_error,upper,lower] = Linear_Sqrt_Bayes_TempFeature(cyc6,usedcap6,num_cycles,6,avg6',model_type(i));
...
for i = 1:length(model_type)
    ...
    xlabel('Cycle')
    ylabel('Used Capacity')
    [rmse,RUL_error,upper,lower] = Linear_Sqrt_Bayes_TempFeature(cyc7,usedcap7,num_cycles,7,variance7',model_type(i));
...
for i = 1:length(model_type)
    ...
    xlabel('Cycle')
    ylabel('Used Capacity')
    [rmse,RUL_error,upper,lower] = Linear_Sqrt_Bayes_TempFeature(cyc8,usedcap8,num_cycles,8,variance8',model_type(i));
